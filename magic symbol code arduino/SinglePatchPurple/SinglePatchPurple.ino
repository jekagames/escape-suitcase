...
drv.go();
delay(600);
colorWipeFade(pixels->Color(150, 60, 120) , 20);
...
drv.go();
delay(600);
colorWipeFade(pixels->Color(200, 40, 150) , 20); 
pulseBrightness();
drv.go();
colorWipeFade(pixels->Color(255, 100, 120) , 20);
delay(200); 
drv.go();
delay(600);
pulseBrightness();
drv.go();
delay(600);
colorWipeFade(pixels->Color(75, 0, 75) , 20); 
delay(300); 
pixels->setBrightness(20);
pixels->show();
pulseBrightness();
