...
drv.setWaveform(1, 69);  // 
drv.setWaveform(2, 107);  // 
drv.setWaveform(3, 46);  // 
//drv.setWaveform(4, 54);  // 
drv.setWaveform(5, 70);  // 
drv.setWaveform(6, 0);  // 
...
drv.go();
delay(600);
colorWipeFade(pixels->Color(150, 120, 60) , 20);
...
drv.go();
delay(600);
colorWipeFade(pixels->Color(200, 100, 20) , 20); 
pulseBrightness();
drv.go();
colorWipeFade(pixels->Color(150, 150, 10) , 20);
delay(200); 
drv.go();
delay(600);
pulseBrightness();
drv.go();
delay(600);
colorWipeFade(pixels->Color(75, 75, 20) , 20); 
delay(300); 
pixels->setBrightness(20);
pixels->show();
pulseBrightness();
