...
drv.go();
delay(600);
colorWipeFade(pixels->Color(240, 30, 20) , 20);
...
drv.go();
delay(600);
colorWipeFade(pixels->Color(200, 80, 40) , 20); 
pulseBrightness();
drv.go();
colorWipeFade(pixels->Color(150, 10, 60) , 20);
delay(200); 
drv.go();
delay(600);
pulseBrightness();
drv.go();
delay(600);
colorWipeFade(pixels->Color(200, 75, 35) , 20); 
delay(300); 
pixels->setBrightness(20);
pixels->show();
pulseBrightness();
